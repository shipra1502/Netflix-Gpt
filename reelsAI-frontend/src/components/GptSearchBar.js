    ...
    <div className="pt-[35%] md:pt-[10%] flex justify-center">
      ...
      >
        <input
          ref={searchText}
          type="text"
          className="p-1 m-4 md:p-6 md:m-6 col-span-9 rounded-md text-sm md:text-lg"
          placeholder={lang[langKey].gptSearchPlaceHolder}
        />

        <button
          className="py-3 md:p-6 m-3 md:m-4 col-span-3 bg-red-400 text-white rounded-md text-sm md:text-lg"
